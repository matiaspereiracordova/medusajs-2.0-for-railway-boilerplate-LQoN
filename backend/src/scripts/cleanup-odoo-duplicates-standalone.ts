...
async function cleanupOdooDuplicatesStandalone() {
  console.log("🧹 Iniciando limpieza de productos duplicados en Odoo (modo standalone)...");
...
async function identifyOdooDuplicatesStandalone() {
  console.log("🔍 Identificando productos duplicados en Odoo (modo standalone)...");
...
async function main() {
  ...
  if (action === "identify") {
    return await identifyOdooDuplicatesStandalone();
  } else {
    return await cleanupOdooDuplicatesStandalone();
  }
}
...
export { cleanupOdooDuplicatesStandalone, identifyOdooDuplicatesStandalone };
export default main;
